	...
	var Root = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      this.state.counters.map(function (counter, idx) {
	        return React.createElement(Counter, { key: counter.id,
	          onDelete: _this2.deleteCounter,
	          onAddClick: _this2.addCount,
	          onMinusClick: _this2.minusCount,
	          counter: counter });
	      })
	    );
	  }
